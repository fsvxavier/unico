...
type NewFeiraLivreRepository struct {
	mock.Mock
}

//GetByID provides a mock function
func (u *NewFeiraLivreRepository) GetByID(id int64) ([]*models.FeiraLivre, error) {
	ret := u.Called(id)
...
func (u *NewFeiraLivreRepository) SearchFeiraLivre(sFeiras *models.SearchFeiraLivre) ([]*models.FeiraLivre, error) {
...
//GetAllByIds provides a mock function
func (u *NewFeiraLivreRepository) GetAllByIds(ids string) ([]*models.FeiraLivre, error) {
	ret := u.Called(ids)
...
// CreateFeiraLivre provides a mock function
func (u *NewFeiraLivreRepository) CreateFeiraLivre(iFeiras *models.FeiraLivre) (*models.Response, error) {
...
func (u *NewFeiraLivreRepository) UpdateFeiraLivre(iFeiras *models.FeiraLivre) (*models.Response, error) {
	ret := u.Called(iFeiras)
...
func (u *NewFeiraLivreRepository) DeleteFeiraLivre(id int64) (*models.Response, error) {
	ret := u.Called(id)
